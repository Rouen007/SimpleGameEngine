...
#define SE_PROFILE_BEGIN_SESSION(name, filepath) ::SE::Instrumentor::Get().BeginSession(name, filepath)
#define SE_PROFILE_END_SESSION() ::SE::Instrumentor::Get().EndSession()
